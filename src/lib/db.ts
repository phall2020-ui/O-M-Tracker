...
export const DEFAULT_SPVS: SPV[] = [
  { id: '9', contractId: 'DEFAULT', code: 'AI', name: 'AMPYR IdeaCo' },
  { id: '1', contractId: 'DEFAULT', code: 'OS2', name: 'Olympus Solar 2 Ltd' },
  { id: '2', contractId: 'DEFAULT', code: 'AD1', name: 'AMPYR Distributed Energy 1 Ltd' },
  { id: '3', contractId: 'DEFAULT', code: 'FS', name: 'Fylde Solar Ltd' },
  { id: '4', contractId: 'DEFAULT', code: 'ESI8', name: 'Eden Sustainable Investments 8 Ltd' },
  { id: '5', contractId: 'DEFAULT', code: 'ESI1', name: 'Eden Sustainable Investments 1 Ltd' },
  { id: '6', contractId: 'DEFAULT', code: 'ESI10', name: 'Eden Sustainable Investments 10 Ltd' },
  { id: '7', contractId: 'DEFAULT', code: 'UV1', name: 'ULTRAVOLT SPV1 LIMITED' },
  { id: '8', contractId: 'DEFAULT', code: 'SKY', name: 'Skylight Energy Ltd' },
];
